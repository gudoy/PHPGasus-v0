(function($) {
  ...
  $.fn.relevantDropdown = function(options) {
    ...
    return this.each(function() {
      ...
      {
      	var $this 	= $(this),
      		idVal 	= $this.val() || $this.data('value'),
      		nameVal = $this.attr('label') || $this.text();
        ...
        temp_item = $("<li />", {
			...
			//"text": $(this).text(),
			//"text": nameVal,
			"html": '<span class="idValue">(' + idVal  + ')</span><span class="nameValue">' + nameVal + '</span>',
			//"html": '<span class="nameValue">' + nameVal + '</span> <span class="idValue">(' + idVal  + ')</span>',
			//"data-value": $(this).val(),
			"value": idVal,
        })[0];
