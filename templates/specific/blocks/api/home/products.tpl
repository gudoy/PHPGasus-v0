			...
			<div class="props">
				...
				<div class="prop samplesURI">
					...
					<ul class="values">
						...
						<li>
							<a class="value" href="{$smarty.const._URL_API}{$rUsedName}.json?limit=-1">
								{$smarty.const._URL_API}{$rUsedName}.json?limit=-1
							</a>
						</li>
					</ul>
				</div>
			...
			<div class="props">
				...
				<div class="prop samplesURI">
					...
					<ul class="values">
						...
						<li>
							<a class="value" href="{$smarty.const._URL_API}{$rUsedName}/boucle-argent.json">
								{$smarty.const._URL_API}{$rUsedName}/boucle-argent.json
							</a>
						</li>
					</ul>
				</div>
