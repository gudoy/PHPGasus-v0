...
<dl>
	...
	<dd class="{cycle values='odd,odd,even,even'} type{$field.type|ucfirst} {$resourceSingular}{$fieldName|ucfirst}{if $isDefaultNamefield} defaultNameField{/if}" id="{$resourceSingular}{$fieldName|ucfirst}">
