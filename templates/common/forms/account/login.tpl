...
<form action="{$data.current.url}" id="frmLogin" class="commonForm loginForm" method="post" enctype="multipart/form-data">
	...
	<fieldset>
		...
		{include file='common/formFields/user/email.tpl' name='email' label="{t}email{/t}" placeholder="{t}email{/t}" autofocus=true}
		...
		<div class="line">
			...
			<div class="fieldBlock">
				{include file='common/formFields/user/password.tpl' label="{t}password{/t}" name='password' placeholder="{t}password{/t}" inputOnly=1}
