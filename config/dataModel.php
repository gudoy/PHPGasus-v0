...
# Resources
// [type]:              native (default) || 'filter' || 'relation' 
// [singular]:          TODO: should be autogenerated if not secified
// [table]:             use resource name by default 
// [alias]:             TODO: autogenerated if not specified (if not already exists, resource first car)
// [crudability]:       allow create,retrieve,update,delete? default = 'CRUD' (allow all). Ex: 'RU' to allow read and update only
// [defaultNameField]   description field mainly use for relation field, to display human readable values instead of ids
// [extends]:           parent resource from which to inherit
